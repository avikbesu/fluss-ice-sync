...
import com.flino.config.ApplicationConfigLoader;
import com.flino.config.SyncSourceConfig;
import com.flino.config.SyncSourceConfigLoader;
import com.flino.health.HealthServer;
import com.flino.ledger.ProcessedFileLedger;
import com.flino.ledger.RetentionSweeper;
import com.flino.process.FileProcessor;
import com.flino.sink.FlussClientSink;
import com.flino.watch.DirectoryWatcher;
import com.flino.watch.FileEvent;
import com.flino.watch.FileStabilityChecker;
...
/** Wires the flino pipeline together and runs it until interrupted. */
